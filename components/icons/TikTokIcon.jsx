...
/**
 * TikTok glyph (lucide-react doesn't ship one).
 * Single-file inline SVG so it bundles with no extra request.
 */
export default function TikTokIcon({ className = '', strokeWidth, ...rest }) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="currentColor"
