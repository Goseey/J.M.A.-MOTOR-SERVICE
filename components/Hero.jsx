    ...
    >
      ...
      <div className="relative z-10 mx-auto w-full max-w-7xl px-5 sm:px-6 lg:px-10">
        <div className="max-w-3xl">
          ...
          >
            Reliable Car Repair & <span className="text-metal-gold">Maintenance</span>{' '}
          ...
          >
            {BADGES.map(({ icon: Icon, label, testid }) => (
              ...
              >
                ...
                <span className="text-[12px] sm:text-[13px] font-medium leading-tight text-white/85">{label}</span>
              </div>
            ))}
          </div>
