...
const SERVICES = [
  { icon: Activity, title: 'Car Diagnostics',
  ...
  { icon: Wrench, title: 'Full Car Service',
  ...
  { icon: Droplets, title: 'Oil & Filter Change',
  ...
  { icon: Disc3, title: 'Brake Inspection & Repair',
    ...
    >
      ...
      <div className="mx-auto max-w-7xl px-5 sm:px-6 lg:px-10">
          ...
          {SERVICES.map(({ icon: Icon, title, description }, i) => (
            ...
            >
              ...
              <div>
                ...
                <p className="mt-2 text-[14px] text-white/60 leading-relaxed">{description}</p>
              </div>
        ...
        <p className="mt-8 text-sm text-white/55">
          ...
          <a href={links.call} className="text-gold-300 hover:text-gold-200 underline-offset-4 hover:underline" data-testid="services-call-link">
            Give us a call
          </a>{' '}
          — chances are we handle it.
        </p>
      </div>
    </section>
  );
