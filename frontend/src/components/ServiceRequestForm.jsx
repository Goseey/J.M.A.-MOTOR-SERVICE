...
function ServiceSelect({ value, onChange, error }) {
  return (
    <div className="relative">
      ...
      <svg
        className="pointer-events-none absolute right-3 top-1/2 -translate-y-1/2 h-4 w-4 text-white/55"
        viewBox="0 0 20 20"
        fill="currentColor"
        aria-hidden="true"
      >
...
function FormDisclaimer() {
  return (
    <div
      className="md:col-span-2 text-[12px] text-white/55 leading-relaxed border-l-2 border-gold-400/50 pl-4"
...
function ServerErrorBanner({ message }) {
  return (
    <div
      className="md:col-span-2 flex items-start gap-3 p-4 bg-red-500/10 border border-red-500/40 text-red-200 rounded-sm"
