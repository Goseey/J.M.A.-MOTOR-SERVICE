...
const POINTS = [
  {
    icon: MapPin,
    title: 'Local Dublin City Centre Garage',
  ...
  {
    icon: Wrench,
    title: 'Practical Repair & Maintenance',
        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-5 lg:sticky lg:top-28">
            ...
            <h2 className="font-display text-3xl sm:text-4xl md:text-[44px] font-bold tracking-tight leading-[1.05]" data-testid="why-us-headline">
              A workshop built on{' '}
              <span className="text-metal-gold">honest work</span>,{' '}
              not marketing.
            </h2>
              ...
              >
                ...
                <div>
                  <div className="flex items-center gap-2">
                    <span className="text-[10px] uppercase tracking-widest2 text-white/35">
                      0{i + 1}
                    </span>
