 ...
 * We show only the real Google aggregate rating.
 */
      ...
      <div className="mx-auto max-w-7xl px-5 sm:px-6 lg:px-10">
        <div className="grid lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-5">
            ...
            <h2 className="font-display text-3xl sm:text-4xl md:text-5xl font-bold tracking-tight leading-[1.05]" data-testid="reviews-headline">
              Rated <span className="text-metal-gold">5.0</span> on Google,<br className="hidden sm:block" /> by real drivers in Dublin.
            </h2>
          ...
          <div className="lg:col-span-7">
            ...
            >
              ...
              <div className="mt-10 flex items-end gap-5 flex-wrap">
                <div className="font-display text-[88px] sm:text-[112px] font-extrabold leading-none text-metal-gold tracking-tighter" data-testid="rating-value">
                  5.0
                </div>
                <div className="pb-3">
                  <div className="flex gap-1" aria-label="5 out of 5 stars">
                    {stars.map((_, i) => (
                      <Star key={i} className="h-6 w-6 fill-gold-400 text-gold-400" strokeWidth={1.5} />
                    ))}
                  </div>
                  <p className="mt-3 text-[14px] text-white/75">
                    Based on <span className="font-semibold text-white" data-testid="review-count">{BUSINESS.reviewCount} verified reviews</span>
                  </p>
